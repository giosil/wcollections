...
class WStruct extends WMap
{
	...
	public WStruct(HttpServletRequest request)
	{
		super(request);
	}
	
	public WStruct(HttpServletRequest request, boolean boCreateSession)
	{
		super(request, boCreateSession);
	}
	
	public WStruct(HttpSession session)
	{
		super(session);
	}
