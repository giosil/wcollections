...
//        sValue = sb.toString();
  ...
  Vector toVector(Object object, boolean notNull)
  {
    ...
    if(object instanceof WList) {
      return ((WList) object).toVector();
    }
    if(object instanceof Collection) {
  ...
  Hashtable toHashtable(Object object, boolean notNull)
  {
    ...
    if(object instanceof WMap) {
      return ((WMap) object).toHashtable();
    }
    if(object instanceof Map) {
      Map map = (Map) object;
    ...
    if(object instanceof String) {
      return notNull ? new Hashtable(0) : null;
    }
    if(object instanceof Collection) {
  ...
  List toList(Object object, boolean notNull)
  {
    ...
    if(object instanceof WList) {
      return ((WList) object).toArrayList();
    }
  ...
  Map toMap(Object object, boolean notNull)
  {
    ...
    if(object instanceof WMap) {
      return ((WMap) object).toHashMap();
    }
    if(object instanceof Map) {
      return (Map) object;
    }
    if(object instanceof String) {
      return notNull ? new HashMap(0) : null;
    }
    if(object instanceof Collection) {
